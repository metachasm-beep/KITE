      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <header className="mb-24 border-b border-white/10 pb-12 flex justify-between items-end">
           <div>
             ...
             <h1 className="text-5xl md:text-7xl font-heading tracking-tight text-white mb-4">SYS_STATUS</h1>
           ...
           <div className="hidden md:flex items-center gap-4 bg-white/5 border border-white/10 px-4 py-2">
        ...
        <div className="grid grid-cols-1 gap-4">
           {systems.map((sys, idx) => (
              <motion.div 
                 ...
                 className="flex flex-col md:flex-row md:items-center justify-between p-6 border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-colors gap-6"
              >
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <span className="text-xs font-bold text-white tracking-[0.2em] block">{sys.label}</span>
                 ...
                 <div className="flex items-center gap-12 font-mono">
                    <div className="flex flex-col text-right">
                       ...
                       <span className="text-[11px] text-white tracking-widest">{sys.uptime}</span>
                    </div>
                    <div className="flex flex-col text-right">
                       <span className="text-[9px] text-zinc-600 tracking-widest">LATENCY</span>
                       <span className="text-[11px] text-white tracking-widest">{sys.ping}</span>
                    </div>
