...
/**
 * Magnetic Tabs — Ruixen UI
 * Sourced from https://ruixen.com/r/magnetic-tabs
 *
        ...
        {items.map((item, i) => (
          <button
            ...
            style={{
              ...
              fontWeight: 500,
              fontFamily: "inherit",
              color: active === item.value ? "var(--mt-text-active)" : "var(--mt-text)",
              cursor: "pointer",
              whiteSpace: "nowrap",
              lineHeight: 1,
