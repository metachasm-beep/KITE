...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
  ...
  useEffect(() => {
    ...
    let { width: currentWidth, height: currentHeight } = updateSize();
    ...
    const drawElectricBorder = (currentTime: number) => {
      ...
      const borderWidth = currentWidth - 2 * borderOffset;
      const borderHeight = currentHeight - 2 * borderOffset;
  ...
  return (
    <div ref={containerRef} className={`electric-border ${className ?? ''}`} style={{ ...style, borderRadius: borderRadius } as any}>
